...
// 3 - any
const arr: any[] = [1, 'teste', true, { nome: 'Marcelo' }]
...
advancedGreeting('Marcelo', 'Araujo')
advancedGreeting('John Doe')
...
userDetails({ name: 'Marcelo', surname: 'Araujo' })
